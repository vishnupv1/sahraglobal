    ...
    <div className="space-y-8 sm:space-y-12 md:space-y-16 pb-0">
      ...
      <section className="relative overflow-visible bg-gradient-to-b from-blue-50/30 via-blue-100/20 to-blue-200/30 -mt-14 sm:-mt-16 pt-14 sm:pt-16">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-28 -left3-30 h-96 w-96 rounded-full bg-gradient-to-br from-blue-400/60 to-blue-600/40 blur-xl " />
          <div className="absolute top-50 right-24 h-[58rem] w-[58rem] rounded-full bg-gradient-to-br from-blue-500/50 via-blue-300/45 to-blue-400/45 blur-xl " />
        </div>
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center justify-center px-4 py-12 text-center sm:px-6 sm:py-16 lg:px-8 lg:py-20 overflow-visible">
          ...
          >
            ...
            className="mt-6 sm:mt-8"
              >
                <Link href="/contact">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 sm:px-8 py-2.5 sm:py-3 text-base sm:text-lg">
                  ...
                  >
                    ...
                    >
                      <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center border border-white/20">
                        <Image src="/starwaylogo.png" alt="Starwaylink" width={128} height={128} quality={100} priority className="w-24 h-24 sm:w-32 sm:h-32 object-contain" />
                      </div>
                    </motion.div>
                  </motion.div>
                    ...
                    <CardContent className="p-4 sm:p-6 md:p-8">
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                          ...
                          <p className="text-xs sm:text-sm text-blue-600 mt-1">•••%</p>
                        </div>
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-3 sm:p-4 rounded-lg sm:rounded-xl">
                          <div className="flex items-center justify-between">
                            <div>
                      ...
                      <div className="bg-gradient-to-r from-blue-400 to-blue-700 p-4 sm:p-6 rounded-lg sm:rounded-xl text-white mb-6 sm:mb-8">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-blue-100 text-xs sm:text-sm">Monthly Revenue</p>
                            <p className="text-2xl sm:text-3xl font-bold">AED ••••</p>
                            <p className="text-blue-200 text-xs sm:text-sm">••% Growth this quarter</p>
                          </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <div className="bg-white p-3 sm:p-4 rounded-lg border">
                          <div className="flex items-center justify-between mb-3 sm:mb-4">
                            ...
                            <span className="text-xs sm:text-sm text-blue-600">View All</span>
                          </div>
          ...
          {/* Hero background pattern: blue gradient overlay + concentric arcs */}
          <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
            {/* Soft blue gradient overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-100/20 via-transparent to-blue-200/30" />
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-b from-white to-blue-50/20">
